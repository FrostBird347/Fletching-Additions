...
public class CustomArrowEntityRenderInfo {
	...
	public CustomArrowEntityRenderInfo(CustomArrowEntity arrow) {
		...
		renderList.add(new CustomArrowEntityRenderPart(arrow, "t", "texture", "0", "b"));
		renderList.add(new CustomArrowEntityRenderPart(arrow, "s", "texture", "0", "b"));
		renderList.add(new CustomArrowEntityRenderPart(arrow, "f", "texture", "0", "b"));
	}
}